...
import { Users, Package, DollarSign, AlertTriangle, Shield } from 'lucide-react';
...
export const AdminDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<'members' | 'assets' | 'disputes' | 'financials'>('members');
